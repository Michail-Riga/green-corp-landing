...
class Bubble {
  ...
  this.init();
    ...
    init() {
        ...
        this.size = generateDecimalBetween(3, 10);
        ...
        this.movementX = generateDecimalBetween(-2, 2) / 
    this.velocity;
        this.movementY = generateDecimalBetween(1, 20) /
    this.velocity;
    }
...
this.translateY = this.translateY - this.movementY;
    if (this.translateY < 0 || this.translateX < 0 ||
